...
import { Container, Typography, Box, Paper, CircularProgress, Breadcrumbs, Icon, Divider, Avatar } from '@mui/material';
import Link from 'next/link';
import { tools, categoryIcons } from '@/lib/constants';
import dynamic from 'next/dynamic';
import { notFound } from 'next/navigation';

export default function ToolPage({ params }: { params: { slug: string } | Promise<{ slug: string }> }) {
